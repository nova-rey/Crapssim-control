diff --git a/crapssim_control/config.py b/crapssim_control/config.py
new file mode 100644
index 0000000000000000000000000000000000000000..1ff74583b2708481b5ee645baf973e0df531dfeb
--- /dev/null
+++ b/crapssim_control/config.py
@@ -0,0 +1,56 @@
