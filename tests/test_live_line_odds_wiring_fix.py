...
def test_line_and_odds_engine_bankroll_and_snapshot():
    ...
    eff_line = a.apply_action("line_bet", {"side":"pass","amount":{"mode":"dollars","value":10}})
    ...
    # Set odds $20 on Pass
    eff_odds = a.apply_action("set_odds", {"on":"pass","amount":{"mode":"dollars","value":20}})
    ...
    eff_take = a.apply_action("take_odds", {"on":"pass","amount":{"mode":"dollars","value":10}})
