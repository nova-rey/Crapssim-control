...
def test_header_written_and_rows_appended_once():
    with tempfile.TemporaryDirectory() as td:
        ...
        assert first_line.startswith("ts,run_id,seed,event_type,point,rolls_since_point,on_comeout,mode,units,bankroll,source,id,action,bet_type,amount,notes,extra")
